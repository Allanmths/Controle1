    ...
    return (
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
        <div className="text-center text-gray-500 dark:text-gray-400">
          ...
          <p>Nenhum alerta ou previsão no momento</p>
          <p className="text-sm mt-2">Seus estoques estão em boas condições!</p>
        </div>
      </div>
    );
  }
      ...
      {trends.length > 0 && (
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
            ...
            Insights de Negócio ({trends.length})
          </h3>
          <div className="space-y-3">
      ...
      {predictiveData.length > 0 && (
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
            ...
            Previsões de Consumo ({predictiveData.length})
          </h3>
          <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-medium text-gray-900 dark:text-white">Reposição Urgente</span>
            </div>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              {alerts.filter(a => a.priority === 'high').length} produtos necessitam reposição imediata
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              {trends.length} insights para otimização de estoque
            </p>
          </div>
        </div>
      </div>
